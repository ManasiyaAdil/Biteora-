...
<div class="container" style="padding: 2.5rem 1.5rem 5rem;">
  <div style="margin-bottom:1.75rem;">
    ...
    <h1 style="font-family:var(--font-display); font-size:2.2rem; font-weight:800; color:#FFFFFF;">Student Profile & Wallet</h1>
  </div>

  <?php if ($msg === 'updated'): ?>
    <div style="background:var(--success-bg); border:1px solid rgba(34,197,94,0.3); border-radius:10px; padding:1rem; margin-bottom:1.5rem; color:var(--success); display:flex; gap:0.65rem; align-items:center;">
  ...
  <div style="display:grid; grid-template-columns:1.2fr 0.8fr; gap:2rem; align-items:flex-start;">
    <!-- Profile Form -->
    <div class="card" style="padding:1.75rem; background:var(--bg-surface);">
      <h3 style="font-family:var(--font-display); font-size:1.15rem; font-weight:700; color:#FFFFFF; margin-bottom:1.25rem; display:flex; align-items:center; gap:0.5rem;">
    ...
    <!-- Campus Wallet Card -->
    <div class="card" style="padding:1.75rem; background:var(--bg-surface); border:1px solid var(--border-subtle);">
      <h3 style="font-family:var(--font-display); font-size:1.15rem; font-weight:700; color:#FFFFFF; margin-bottom:1.25rem; display:flex; align-items:center; gap:0.5rem;">
        <i class="fa-solid fa-wallet text-orange"></i> Campus Smart Wallet
      </h3>

      <div style="background:linear-gradient(135deg, #FF5A36 0%, #FF7A45 100%); border-radius:14px; padding:1.5rem; color:#FFFFFF; margin-bottom:1.5rem; box-shadow:var(--shadow-orange); position:relative; overflow:hidden;">
        <div style="display:flex; justify-content:space-between; align-items:flex-start; margin-bottom:1.5rem;">
          <span style="font-family:var(--font-display); font-weight:800; font-size:1.15rem;">CampusBite Card</span>
      ...
      <div style="background:var(--bg-surface-2); padding:1rem; border-radius:10px; font-size:0.85rem; color:var(--text-secondary);">
        <div style="font-weight:700; color:#FFFFFF; margin-bottom:0.25rem;">Direct Cafeteria Integration</div>
