...
<head>
  ...
  <title><?php echo isset($page_title) ? $page_title . ' | CampusBite' : 'CampusBite - Smart Campus Food Ordering & Queue Management'; ?></title>
  ...
  <header class="cb-navbar">
    <div class="container cb-navbar-inner">
      ...
      <ul class="cb-nav-links">
        ...
        <li><a href="index.php#why-campusbite" class="cb-nav-link">Why CampusBite</a></li>
