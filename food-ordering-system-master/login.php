...
<div class="container" style="padding: 3.5rem 1.5rem 5rem; display:flex; align-items:center; justify-content:center;">
  <div class="card" style="width:100%; max-width:440px; padding:2rem; background:var(--bg-surface); border:1px solid var(--border-subtle); border-radius:20px; box-shadow:var(--shadow-lg);">
    <div style="text-align:center; margin-bottom:1.75rem;">
      <div class="cb-logo-icon" style="margin:0 auto 0.85rem; width:44px; height:44px; font-size:1.3rem;">
        <i class="fa-solid fa-utensils"></i>
      </div>
      <h2 style="font-family:var(--font-display); font-size:1.75rem; font-weight:800; color:#FFFFFF;">Welcome to CampusBite</h2>
    ...
    <form method="POST" action="routers/router.php">
      ...
      <div class="form-group">
        ...
        <div style="position:relative;">
          ...
          <input type="text" name="username" id="cb-login-username" class="form-control" placeholder="Enter your username" required style="padding-left:2.5rem;">
        </div>
      </div>
      ...
      <div class="form-group" style="margin-bottom:1.25rem;">
        ...
        <div style="position:relative;">
          ...
          <input type="password" name="password" id="cb-login-password" class="form-control" placeholder="Enter your password" required style="padding-left:2.5rem;">
        </div>
      </div>
      ...
      <div style="background:var(--bg-surface-2); border:1px dashed var(--border-subtle); border-radius:10px; padding:0.85rem; margin-bottom:1.25rem;">
      ...
      <div style="text-align:center; font-size:0.85rem; color:var(--text-secondary);">
        New to CampusBite? <a href="register.php" style="color:var(--brand-primary); font-weight:700;">Create an Account</a>
      </div>
    </form>
  </div>
</div>
