...
<body style="background:#0B0B0D;">
  ...
  <div style="display:flex; min-height:100vh;">
    <!-- Admin Sidebar -->
    <aside style="width:260px; background:var(--bg-surface); border-right:1px solid var(--border-subtle); padding:1.5rem 1rem; display:flex; flex-direction:column; flex-shrink:0;">
      ...
      <div style="padding:0.75rem 1rem; background:var(--brand-subtle); border:1px solid rgba(255,90,54,0.3); border-radius:10px; margin-bottom:1.25rem; display:flex; align-items:center; gap:0.65rem;">
        <div style="width:32px; height:32px; border-radius:50%; background:var(--brand-primary); color:#FFFFFF; display:flex; align-items:center; justify-content:center; font-weight:bold; font-size:0.85rem;">
          <i class="fa-solid fa-user-shield"></i>
        </div>
        <div>
          <div style="font-weight:700; font-size:0.88rem; color:#FFFFFF;"><?php echo htmlspecialchars($_SESSION['name'] ?? 'Admin'); ?></div>
          <div style="font-size:0.72rem; color:var(--brand-primary);">Cafeteria Manager</div>
        </div>
      </div>

      <ul style="list-style:none; display:flex; flex-direction:column; gap:0.4rem; flex-grow:1;">
        <li><a href="admin-page.php" class="btn btn-secondary" style="width:100%; justify-content:flex-start; background:var(--brand-primary); color:#FFFFFF; border-color:var(--brand-primary);"><i class="fa-solid fa-chart-pie" style="width:20px;"></i> Dashboard</a></li>
        <li><a href="all-orders.php" class="btn btn-secondary" style="width:100%; justify-content:flex-start;"><i class="fa-solid fa-receipt" style="width:20px;"></i> Orders Queue</a></li>
        <li><a href="admin-menu.php" class="btn btn-secondary" style="width:100%; justify-content:flex-start;"><i class="fa-solid fa-bowl-food" style="width:20px;"></i> Food Menu</a></li>
        <li><a href="admin-categories.php" class="btn btn-secondary" style="width:100%; justify-content:flex-start;"><i class="fa-solid fa-layer-group" style="width:20px;"></i> Categories</a></li>
        <li><a href="users.php" class="btn btn-secondary" style="width:100%; justify-content:flex-start;"><i class="fa-solid fa-users" style="width:20px;"></i> Students</a></li>
    ...
    <main style="flex-grow:1; padding:2rem 2.5rem; overflow-y:auto;">
      ...
      <div style="display:flex; align-items:center; justify-content:space-between; flex-wrap:wrap; gap:1.25rem; margin-bottom:2rem;">
        <div>
          ...
          <h1 style="font-family:var(--font-display); font-size:2.1rem; font-weight:800; color:#FFFFFF;">Cafeteria Dashboard</h1>
        </div>
      ...
      <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(220px, 1fr)); gap:1.25rem; margin-bottom:2.25rem;">
        <div class="card" style="padding:1.25rem; background:var(--bg-surface);">
          ...
          <div style="font-family:var(--font-display); font-size:2.2rem; font-weight:800; color:#FFFFFF;"><?php echo $today_orders; ?></div>
        </div>
      ...
      <!-- Live Queue Stream (Needs Action) -->
      <div class="card" style="padding:1.5rem; background:var(--bg-surface); margin-bottom:2rem;">
        <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:1.25rem;">
          <h3 style="font-family:var(--font-display); font-size:1.2rem; font-weight:800; color:#FFFFFF;">
        ...
        <?php else: ?>
          <div style="overflow-x:auto;">
            <table style="width:100%; border-collapse:collapse; font-size:0.88rem;">
              <thead>
                <tr style="border-bottom:1px solid var(--border-subtle); color:var(--text-muted); text-align:left; font-size:0.75rem; text-transform:uppercase;">
                  <th style="padding:0.6rem 0.5rem;">Token</th>
                  <th style="padding:0.6rem 0.5rem;">Order Ref</th>
                  <th style="padding:0.6rem 0.5rem;">Student</th>
                  <th style="padding:0.6rem 0.5rem;">Items</th>
                  <th style="padding:0.6rem 0.5rem;">Status</th>
                  <th style="padding:0.6rem 0.5rem; text-align:right;">Kitchen Action</th>
                </tr>
              </thead>
              <tbody>
                <?php foreach ($live_orders as $lo): ?>
                  <tr style="border-bottom:1px solid rgba(255,255,255,0.04); color:#FFFFFF;">
                    ...
                    <td style="padding:0.75rem 0.5rem; font-family:var(--font-display); font-weight:700;">
                      #<?php echo htmlspecialchars($lo['order_code'] ?: 'CB-'.$lo['id']); ?>
                    </td>
                    <td style="padding:0.75rem 0.5rem;">
                      <div><?php echo htmlspecialchars($lo['customer_name']); ?></div>
                      <div style="font-size:0.75rem; color:var(--text-muted);"><?php echo htmlspecialchars($lo['customer_contact']); ?></div>
                    </td>
                    <td style="padding:0.75rem 0.5rem; max-width:260px; font-size:0.82rem; color:var(--text-secondary);">
                    ...
                    <td style="padding:0.75rem 0.5rem; text-align:right;">
                      <form method="POST" action="routers/order-router.php" style="display:inline-flex; gap:0.4rem;">
                        ...
                        <?php elseif ($lo['status'] === 'Ready'): ?>
                          <button type="submit" name="status" value="Completed" class="btn btn-sm btn-secondary" style="color:var(--success); border-color:rgba(34,197,94,0.3);">
