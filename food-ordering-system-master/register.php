...
<div class="container" style="padding: 3.5rem 1.5rem 5rem; display:flex; align-items:center; justify-content:center;">
  <div class="card" style="width:100%; max-width:480px; padding:2rem; background:var(--bg-surface); border:1px solid var(--border-subtle); border-radius:20px; box-shadow:var(--shadow-lg);">
    <div style="text-align:center; margin-bottom:1.75rem;">
      <div class="cb-logo-icon" style="margin:0 auto 0.85rem; width:44px; height:44px; font-size:1.3rem;">
        <i class="fa-solid fa-user-plus"></i>
      </div>
      <h2 style="font-family:var(--font-display); font-size:1.75rem; font-weight:800; color:#FFFFFF;">Student Registration</h2>
      <p style="font-size:0.85rem; color:var(--text-secondary); margin-top:0.25rem;">Create your CampusBite account to start digital ordering.</p>
    </div>
    ...
    <form method="POST" action="routers/register-router.php">
      <div class="form-group">
        ...
        <div style="position:relative;">
          ...
          <input type="text" name="name" class="form-control" placeholder="e.g. Rahul Sharma" required style="padding-left:2.5rem;">
        </div>
      </div>
      ...
      <div style="display:grid; grid-template-columns:1fr 1fr; gap:0.85rem;">
        <div class="form-group">
          ...
          <div style="position:relative;">
            ...
            <input type="text" name="username" class="form-control" placeholder="e.g. rahul123" required style="padding-left:2.5rem;">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div style="position:relative;">
            ...
            <input type="tel" name="phone" class="form-control" placeholder="e.g. 9876543210" required style="padding-left:2.5rem;">
          </div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div style="position:relative;">
          ...
          <input type="email" name="email" class="form-control" placeholder="e.g. rahul@campus.edu" style="padding-left:2.5rem;">
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div style="position:relative;">
          ...
          <input type="text" name="address" class="form-control" placeholder="e.g. Hostel Block B, Room 204" required style="padding-left:2.5rem;">
        </div>
      </div>
      ...
      <div class="form-group" style="margin-bottom:1.5rem;">
        ...
        <div style="position:relative;">
          ...
          <input type="password" name="password" class="form-control" placeholder="Choose a secure password" required minlength="4" style="padding-left:2.5rem;">
        </div>
      </div>
