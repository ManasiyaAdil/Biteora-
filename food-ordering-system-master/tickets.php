...
<div class="container" style="padding: 3rem 1.5rem 5rem;">
  <div style="margin-bottom:2rem;">
    <span style="color:#10B981; font-weight:700; font-size:0.85rem; text-transform:uppercase; letter-spacing:1px;">Helpdesk & Feedback</span>
    <h1 style="font-family:'Outfit',sans-serif; font-size:2.3rem; font-weight:800; color:#F8FAFC;">Campus Cafeteria Support</h1>
  </div>
  ...
  <div style="display:grid; grid-template-columns:1fr 1.2fr; gap:2.5rem; align-items:flex-start;">
    ...
    <div class="card" style="padding:2rem;">
      <h3 style="font-family:'Outfit',sans-serif; font-size:1.25rem; font-weight:700; color:#F8FAFC; margin-bottom:1.5rem; display:flex; align-items:center; gap:0.5rem;">
        <i class="fa-solid fa-pen-to-square text-emerald"></i> Submit New Inquiry
      </h3>
      ...
      <form method="POST" action="tickets.php">
        ...
        <div class="form-group">
          ...
          <select name="type" class="form-control" style="background:#0A122A;">
    ...
    <!-- Ticket History -->
    <div class="card" style="padding:2rem;">
      <h3 style="font-family:'Outfit',sans-serif; font-size:1.25rem; font-weight:700; color:#F8FAFC; margin-bottom:1.5rem;">
        Your Past Tickets (<?php echo count($tickets); ?>)
      </h3>

      <?php if (count($tickets) === 0): ?>
        <p style="color:#94A3B8; text-align:center; padding:2rem 0;">You haven't submitted any support tickets yet.</p>
      <?php else: ?>
        <div style="display:flex; flex-direction:column; gap:1rem;">
          <?php foreach ($tickets as $t): ?>
            <div style="background:#070D1E; border:1px solid rgba(255,255,255,0.06); border-radius:12px; padding:1.25rem;">
              <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:0.4rem;">
                <h4 style="font-family:'Outfit',sans-serif; font-weight:700; font-size:1.05rem; color:#F8FAFC;"><?php echo htmlspecialchars($t['subject']); ?></h4>
                <span class="badge badge-<?php echo ($t['status'] === 'Answered' ? 'emerald' : ($t['status'] === 'Closed' ? 'gray' : 'amber')); ?>">
                  <?php echo htmlspecialchars($t['status']); ?>
                </span>
              </div>
              <p style="font-size:0.88rem; color:#CBD5E1; margin-bottom:0.75rem; line-height:1.45;"><?php echo htmlspecialchars($t['description']); ?></p>
