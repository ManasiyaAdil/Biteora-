...
<div class="container" style="padding: 2.5rem 1.5rem 5rem;">
  <div style="margin-bottom:1.75rem;">
    ...
    <h1 style="font-family:var(--font-display); font-size:2.2rem; font-weight:800; color:#FFFFFF;">Your Food Cart</h1>
  </div>
  ...
  <div style="display:grid; grid-template-columns:1.35fr 0.85fr; gap:2rem; align-items:flex-start;">
    ...
    <div class="card" style="padding:1.5rem;">
      <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:1.25rem; padding-bottom:0.85rem; border-bottom:1px solid var(--border-subtle);">
        <h3 style="font-family:var(--font-display); font-size:1.15rem; font-weight:700; color:#FFFFFF;">Selected Dishes</h3>
      ...
      <div id="cb-cart-empty" style="display:none; text-align:center; padding:3.5rem 1rem;">
        ...
        <h4 style="font-family:var(--font-display); font-size:1.25rem; color:#FFFFFF; margin-bottom:0.4rem;">Your cart is empty</h4>
    ...
    <div class="card" style="padding:1.5rem; position:sticky; top:85px; background:var(--bg-surface); border:1px solid var(--border-subtle);">
      <h3 style="font-family:var(--font-display); font-size:1.2rem; font-weight:700; color:#FFFFFF; margin-bottom:1.25rem;">Order Summary</h3>
      ...
      <div style="margin-bottom:1.25rem; background:var(--bg-surface-2); border:1px solid var(--border-subtle); border-radius:10px; padding:0.75rem;">
        ...
        <div style="display:flex; gap:0.5rem;">
          <label style="flex:1; display:flex; align-items:center; justify-content:center; gap:0.4rem; padding:0.5rem; background:var(--bg-surface); border:1px solid var(--brand-primary); border-radius:8px; font-size:0.85rem; font-weight:700; color:#FFFFFF; cursor:pointer;">
            <input type="radio" name="dining_mode" value="pickup" checked style="accent-color:var(--brand-primary);"> Counter Pickup
          </label>
          <label style="flex:1; display:flex; align-items:center; justify-content:center; gap:0.4rem; padding:0.5rem; background:var(--bg-surface); border:1px solid var(--border-subtle); border-radius:8px; font-size:0.85rem; font-weight:700; color:var(--text-secondary); cursor:pointer;">
      ...
      <div style="display:flex; flex-direction:column; gap:0.75rem; margin-bottom:1.25rem; font-size:0.9rem;">
        <div style="display:flex; justify-content:space-between; color:var(--text-secondary);">
          <span>Subtotal</span>
          <span id="cb-cart-total" style="font-weight:700; color:#FFFFFF;">₹0.00</span>
        </div>
        <div style="display:flex; justify-content:space-between; color:var(--text-secondary);">
        ...
        <div style="border-top:1px solid var(--border-subtle); padding-top:0.85rem; display:flex; justify-content:space-between; align-items:center;">
          <span style="font-weight:800; font-size:1.05rem; color:#FFFFFF;">Grand Total</span>
